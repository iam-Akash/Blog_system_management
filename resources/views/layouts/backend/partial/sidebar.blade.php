<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <img src="{{ asset('storage/profile_picture/'.Auth::user()->image) }}" width="48" height="48" alt="User" />
        </div>
        ...
        <div class="info-container">
            ...
            <div class="btn-group user-helper-dropdown">
                ...
                <ul class="dropdown-menu pull-right">
                    <li><a href="{{ Auth::user()->role_id==1? route('admin.profile.settings'):route('author.profile.settings') }}"><i class="material-icons">settings</i>Profile settings</a></li>
    ...
    <div class="menu">
        <ul class="list">
            ...
            @if (Request::is('admin*'))
                ...
                <li class="{{Request::is('admin/list/authors')? 'active' : ''}}">
                    <a href="{{route('admin.list.authors')}}">
    ...
    <div class="legal">
        <div class="copyright">
            &copy; 2014 - 2017 <a href="javascript:void(0);">Blog System Management</a>.
        </div>
        <div class="version">
            <b>Version: </b> 1.0.5
        </div>
