        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group custom-form text-right">
                    <a type="button" href="{{route('admin.post.index')}}" class="btn btn-danger waves-effect">CANCEL</a>
                    ...
                    <div class="body">
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="form-group form-float" style="margin-bottom: 0">
                                ...
                                <input type="checkbox" class="filled-in" value="1" {{$post->status==true? 'checked' : ''}} id="publish" name="status">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <textarea name="body" id="ckeditor">{{$post->body }}</textarea>
                            @error('body')
